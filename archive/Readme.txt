...
　※材質のポリ割りが「四角＋対角線の三角形２つが組み合わされたメッシュ」で
...
----------------------------------------------------------------
 ...
 1. 物理を割り当てしたいメッシュのある材質を確認します
    ...
    ・材質を分ける場合、PMXEditorでは「編集＞選択面＞頂点を分離して新規材質へ取り出し」を実行してください

 2. PmxTailorを起動します

 3. 対象モデルに 1. のモデルを指定します
...
　https://docs.google.com/forms/d/13uYpkYMO0xv2VDTvZv_SmGEDQipkkHmQU6rpHTBJC7I
