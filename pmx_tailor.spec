...
a = Analysis(['src\\executor.py'],
             pathex=['src'],
             binaries=[],
             datas=[('src\\pmx_tailor.ico', 'src'), ('.\\src\\locale\\en_US\\messages.json', 'src\\locale\\en_US'), ('.\\src\\locale\\ja_JP\\messages.json', 'src\\locale\\ja_JP'), ('.\\src\\locale\\zh_CN\\messages.json', 'src\\locale\\zh_CN')],
             hiddenimports=['pkg_resources', 'wx._adv', 'wx._html', 'bezier', 'quaternion', 'module.MParams', 'utils.MBezierUtils', 'numpy.core.multiarray'],
             hookspath=[],
             runtime_hooks=[],
